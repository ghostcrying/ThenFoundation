...
public class KeychainSwift {
    ...
    public func set(_ value: Data, forKey key: String,
        ...
        var query: [String : Any] = [
            ...
            KeychainSwiftConstants.attrGeneric : prefixedKey,
    ...
    public var allKeys: [String] {
        ...
        if lastResultCode == noErr {
            return (result as? [[String: Any]])?.compactMap {
                $0[KeychainSwiftConstants.attrGeneric] as? String } ?? []
        }
    ...
    public func deleteNoLock(_ key: String) -> Bool {
        ...
        var query: [String: Any] = [ KeychainSwiftConstants.klass       : kSecClassGenericPassword,
                                     KeychainSwiftConstants.attrGeneric : prefixedKey]
