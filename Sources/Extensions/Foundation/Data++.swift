...
public extension ThenExtension where T == Data {
    ...
    var hexString: String {
        return value.withUnsafeBytes { $0.reduce("") { $0 + String(format: "%02hhx", $1) } }
    }
    
    var base64Value: String {
        let base64String = value.base64EncodedString(options: NSData.Base64EncodingOptions(rawValue: 0))
